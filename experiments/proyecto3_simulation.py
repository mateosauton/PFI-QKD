...
def background_yield(dark_count_hz: float, detection_window_ps: float, detectors: int = 3) -> float:
    """Analytic dark-click probability for an assumed gate around one pulse."""
...
def plot_experiment_1(
    ...
    reference_no_margin_start_distance: float,
    out_dir: Path,
) -> None:
...
def main() -> None:
    ...
    metadata = {
        ...
        "source_sha256": {
            "proyecto3_simulation.py": _sha256(Path(__file__).resolve()),
