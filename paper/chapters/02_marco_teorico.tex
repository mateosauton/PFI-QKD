...
donde \(R_\text{tamizada}\) es el throughput de bits tamizados, \(Q\) es el QBER, \(f_\text{EC}\) modela la ineficiencia de corrección de errores y \(h_2\) es la entropía binaria. La simulación usa el umbral práctico de aproximadamente \(11\,\%\) como referencia: por encima de ese valor la cota simple se anula.
