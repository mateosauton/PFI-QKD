...
El estado del arte sugiere tres decisiones para la memoria. Primero, concentrarse en BB84 con estados señuelo es razonable porque combina madurez teórica, implementaciones prácticas y relación directa con fuentes coherentes débiles. Segundo, estudiar \textit{time-bin} o codificación de fase sobre fibra tiene sentido para telecomunicaciones porque se alinea con canales ópticos reales. Tercero, una red de campus debe pensarse por capas: enlace QKD, administración de llaves y aplicación. La simulación actual cubre la primera capa; las demás se documentan como arquitectura futura.
