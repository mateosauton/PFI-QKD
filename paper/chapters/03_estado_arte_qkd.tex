...
ETSI GS QKD 020 V1.1.1, publicada en junio de 2026, complementa esa interfaz hacia el interior de la infraestructura: especifica el protocolo y el formato de datos de una API REST interoperable entre sistemas de administración de claves QKD \cite{etsiQKD020}. QKD 014 describe la entrega entre el KMS y la aplicación; QKD 020 aborda la coordinación entre KMS. La distinción resulta pertinente para una futura red UNSAM con más de un enlace o con un nodo confiable, aunque ninguna de las dos interfaces se implementa en la simulación de este trabajo.
