...
En esta versión del trabajo se decidió no modificar el modelo Python ni agregar nuevas corridas. Esta decisión mantiene trazabilidad con los resultados ya generados y evita mezclar dos objetivos: mejorar el simulador y ampliar la documentación. Por lo tanto, el crecimiento del trabajo se concentra en explicar mejor el contexto, las hipótesis, los supuestos, la interpretación de resultados y la conexión con una implementación de campus.

La consecuencia metodológica es que algunas mejoras se formulan como trabajo futuro, no como resultados nuevos. En particular, barras de error, mapas bidimensionales, exportación CSV e implementación decoy completa quedan identificados, pero no se presentan como evidencia experimental de esta iteración. Esta separación hace que el trabajo sea más honesta: documenta lo hecho, justifica por qué sirve y declara qué falta para una siguiente etapa.
