...
La modulación requiere dos funciones distintas. El LNA6213 es un modulador de intensidad y puede controlar señal y señuelo; no se lo usa como modulador de fase. Para imponer la fase relativa \(0/\pi\) se necesita un componente separado, por ejemplo un modulador de fase LN53S-FC o un equivalente vigente para 1550 nm \cite{thorlabsLNA6213,thorlabsLN53SFC}.
...
\begin{figure}[p]
  ...
  \caption{Modulador de intensidad LiNbO\(_3\) Thorlabs LNA6213 como referencia para controlar señal y señuelo. La fase requiere un modulador separado \cite{thorlabsLNA6213,thorlabsLN53SFC}.}
...
\begin{longtable}{@{}p{0.15\textwidth}p{0.22\textwidth}p{0.31\textwidth}p{0.20\textwidth}@{}}
  ...
  Intensidad & Thorlabs LNA6213 & Modulador LiNbO\(_3\) para controlar la potencia óptica & Señal, señuelo y vacío \\
  Fase & Thorlabs LN53S-FC o equivalente & Modulador LiNbO\(_3\) de fase para la ventana de 1550 nm & Fase relativa \(0/\pi\) y base X \\
