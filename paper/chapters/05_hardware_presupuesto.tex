...
\begin{figure}[H]
  ...
  \begin{minipage}{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{thorlabs-kls1550-page.png}
  \end{minipage}\hfill
  \begin{minipage}{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{thorlabs-lna6213-page.png}
  \end{minipage}
  \caption{Fuente láser Thorlabs KLS1550 y moduladores LiNbO\(_3\) de la familia LNA/LNP como referencias para fuente y modulación en 1550 nm \cite{thorlabsKLS1550,thorlabsLNA6213}.}
  \label{fig:instrumentos_fuente_modulador}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.78\textwidth]{id230-detector.png}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{time-tagger-ultra.png}
  \end{minipage}
  \caption{Detector de fotón único ID Quantique ID230 y time tagger Swabian Instruments Time Tagger Ultra, usados como referencias para eficiencia, conteos oscuros, jitter, resolución temporal y registro de eventos \cite{idqID230,swabianTimeTagger}.}
  \label{fig:instrumentos_detector_tagger}
\end{figure}
...
\begin{longtable}{@{}p{0.15\textwidth}p{0.22\textwidth}p{0.31\textwidth}p{0.20\textwidth}@{}}
  ...
  Detector & ID Quantique ID230 & InGaAs/InP en telecom, eficiencia ajustable hasta \SI{25}{\percent}, conteos oscuros bajos y resolución temporal sub-ns & Eficiencia, conteos oscuros, resolución temporal \\
  Time tagger & Swabian Time Tagger Ultra & Resolución digital de \SI{1}{\pico\second}, jitter de pocos ps según configuración y múltiples canales & Ventanas \textit{time-bin}, sincronización \\
...
El valor de esta tabla es conectar hojas de datos con decisiones de simulación. Si se elige otro detector, cambian eficiencia, dark counts, tiempo muerto y jitter. Si se elige otro modulador, cambian pérdida de inserción, ancho de banda y estabilidad de fase. Si se elige una fuente con menor control de potencia, el ajuste de \(\mu\) se vuelve más incierto. Por lo tanto, el presupuesto no debe evaluarse solo por costo unitario: debe evaluarse por el impacto de cada instrumento sobre QBER, SKR y repetibilidad del banco.
