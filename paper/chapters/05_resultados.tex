...
La Figura~\ref{fig:exp1_distance} muestra el barrido de distancia. La probabilidad de detección analítica cae casi exponencialmente con la distancia, como se espera para una fibra con atenuación expresada en dB/km. El QBER se mantiene bajo durante la mayor parte del barrido y aumenta abruptamente en el punto de mayor distancia, donde supera el umbral de referencia de \SI{11}{\percent}. Este comportamiento indica que, bajo los parámetros elegidos, el enlace conserva margen operativo hasta distancias del orden de varias decenas de kilómetros, pero se vuelve inestable cerca del extremo superior del barrido.
