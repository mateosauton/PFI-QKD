...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{p{0.27\textwidth}p{0.18\textwidth}X}
    ...
    Barrido de distancia & Cumplido con límite & QBER bajo el umbral ideal hasta 69,54 km y aumento abrupto en 77,15 km; no es alcance físico \\
...
La primera prioridad es explicar la transición de QBER entre 69,54 y \SI{77.15}{\kilo\meter}. Para ello deben exportarse errores por base y ronda, marcas temporales de mensajes, índices emparejados y composición de clics de señal y fondo. La prueba debe verificar si el aumento proviene del régimen físico idealizado o de alineación y solapamiento en la implementación protocolar.
