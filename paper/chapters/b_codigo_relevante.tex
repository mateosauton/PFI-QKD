...
Este apéndice selecciona fragmentos de \path{experiments/proyecto3_simulation.py}. El objetivo es mostrar cómo las decisiones metodológicas se traducen a código. Los recortes no reemplazan el archivo ejecutable ni sus validaciones.
